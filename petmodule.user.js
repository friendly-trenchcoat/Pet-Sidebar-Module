...
(function () {
    ...
    function settings_HTML() {
        ...
        const html =
            ...
            <table name="misc"> <tr> <td> <table> <tr> <td> <div>always use beta theme bg</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="betaBG"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>NP links to inventory</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="npLinkInv" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>NC links to mall</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="ncLinkMall" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> <td> </td> </tr> </table>
            </div> 
    ...
    function set_np_link(inv) {
        $('.navsub-right__2020>a').eq(0).attr('href', inv ? '/inventory.phtml' : '/bank.phtml');
    }
    function set_nc_link(mall) {
        $('.navsub-right__2020>a').eq(1).attr('href', mall ? '/mall/index.phtml' : 'https://secure.nc.neopets.com/get-nickcash' );
    }
