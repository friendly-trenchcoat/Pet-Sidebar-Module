...
(function () {
    ...
    function main() {
        ...
        // utility
        else if (document.URL.indexOf("/hospital/volunteer") != -1) VoidVolunteer();
    ...
    function add_pet(petname) {
        ...
        const gravedanger = PETS[petname].owner == USER && DATA.gravedanger && PETS[petname].petpet_danger >= 0 && (new Date).getTime() > PETS[petname].petpet_danger ?
            ' style="display: flex;"' : '';
        const volunteer = PETS[petname].owner == USER && DATA.volunteer && PETS[petname].void_volunteer >= 0 && (new Date).getTime() > PETS[petname].void_volunteer ?
            ' style="display: flex;"' : '';
        ...
        $('#' + inactive + 'active_' + petname).append(
            ...
            '<div class="timers"> \
                ...
                <div class="void-volunteer"'+ volunteer + '> \
                    <a href="https://www.neopets.com/hospital/volunteer.phtml"><i class="fas fa-stethoscope fa-lg"></i></a> \
                </div> \
            </div> \
    ...
    function settings_HTML() {
        ...
        const html =
            ...
            <table name="general" class="tab-active"> <tr> <td> <table> <tr> <td> <div>navigation menu</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="showNav" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>pet stats slider</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="showStats" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>keep active pet at top</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="stickyActive" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>display true expression</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="trueExpression" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>all accounts</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="allAccts" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> <td> <table> <tr> <td> <div>neolodge reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="neolodge"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>training reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="training"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>grave danger reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="gravedanger"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>hospital volunteering reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="volunteer"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>debug mode</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="debug"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> </tr> </table>
    ...
    function VoidVolunteer() {
        psm_debug('Void Volunteer');
        let remaining, petname;
        // TODO: mutationobserver to detect new shift started instead of this:
        for (petname in PETS) {
            PETS[petname].void_volunteer = -1;
        }
        $('.vc-fight-details').each((k,v) => {
            petname = $(v).find('.vc-pet-name').text();
            remaining = $(v).find('.vc-fight-time').text();
            const match = new RegExp(/^(\d+):(\d+):(\d+)/g).exec(remaining);
            if (petname && match) {
                remaining = match[1] * 3600000 + match[2] * 60000 + match[3] * 1000;
                PETS[petname].void_volunteer = (new Date).getTime() + remaining;
                psm_debug('Remaining volunteer time',petname,remaining);
                $(v).find('.vc-fight-service>button').one('click', (e) => {
                    const action = $(e.target).text();
                    psm_debug('End volunteering',petname,action);
                    PETS[petname].void_volunteer = -1;
                    set_items(false, true, true);
                });
            }
