...
(function () {
    ...
    const VERSION = '2.0.3';
    let SPECTRUM = false;
    let USER, PETS, DATA, $CONTAINER, $MODULE, THEME, CSS, BG_CSS, MISC_CSS, CONTAINER_CSS, BDR, BG, IS_BETA, CUR_SHOWN;
    ...
    function setGlobals() {
        ...
        if (IS_BETA) {
            ...
            BDR = "rgba(255, 255, 255, 0.99)";
            BG = "rgba(255, 255, 255, 0.99)";
            if (DATA.jumbo) $('.sidebar').addClass('jumbo');
    ...
    function is_reminder_enabled(petname, reminder) {
        let attr = reminder === 'gravedanger' ? 'petpet_danger' : reminder;
        return PETS[petname]?.owner == USER && DATA[reminder] && PETS[petname]?.[attr] >= 0;
    }
    function is_in_alarm(petname, reminder) {
        return is_reminder_enabled(petname, reminder) && ( get_remaining_ms(petname, reminder) < 0 || ( reminder === 'neolodge' && is_hungry(PETS[petname].hunger) ) );
    }
    function get_remaining_ms(petname, reminder) {
        let attr = reminder === 'gravedanger' ? 'petpet_danger' : reminder;
        return PETS[petname]?.[attr] - (new Date).getTime();
    }
    function get_remaining(petname, reminder) {
        return msToStr(get_remaining_ms(petname, reminder)) || 'None';
    }
    ...
    function add_pet(petname) {
        ...
        const neolodge = is_in_alarm(petname, 'neolodge') ? ' style="display: flex;"' : '';
        const training = is_in_alarm(petname, 'training') ? ' style="display: flex;"' : '';
        const gravedanger = is_in_alarm(petname, 'gravedanger') ? ' style="display: flex;"' : '';
        ...
        $('#' + inactive + 'active_' + petname).append(
            ...
            '<div class="timers"> \
                <div class="neolodge"'+ neolodge + '> \
                    <a href="https://www.neopets.com/neolodge.phtml?pet_name=' + petname + '"><i class="fas fa-concierge-bell fa-lg"></i></a> \
                </div> \
            ...
            ${outerHTML ? `<div id="stats_${petname}" class="hover stats" petname="${petname}">` : ''}
                <div class="inner"${petpetStyle}>
                    <div class="petheader">
                        ...
                        ${DATA.sliderReminders !== '0' ? `<div class="petreminders">${
                            is_reminder_enabled(petname, 'neolodge') ? `<div class="neolodge" title="Neolodge Time Remaining: ${get_remaining(petname, 'neolodge')}"><a href="https://www.neopets.com/neolodge.phtml?pet_name=${petname}"><i class="fas fa-concierge-bell fa-lg"></i></a></div>` : 
                            DATA.sliderReminders === '2' ? `<div class="neolodge" title="Neolodge Inactive"><a href="https://www.neopets.com/neolodge.phtml?pet_name=${petname}"><i class="fas fa-concierge-bell inactive"></i></a></div>` : ''
                        }${
                            is_reminder_enabled(petname, 'training') ? `<div class="training" title="Training Time Remaining: ${get_remaining(petname, 'training')}"><a href="${PETS[petname].training_url}"><i class="fas fa-dumbbell fa-lg"></i></a></div>` : 
                            DATA.sliderReminders === '2' ? `<div class="training" title="Training Inactive"><a href="${PETS[petname].training_url || 'https://www.neopets.com/island/training.phtml?type=status'}"><i class="fas fa-dumbbell inactive"></i></a></div>` : ''
                        }${
                            is_reminder_enabled(petname, 'gravedanger') ? `<div class="gravedanger" title="Grave Danger Time Remaining: ${get_remaining(petname, 'gravedanger')}"><a href="https://www.neopets.com/halloween/gravedanger/index.phtml"><i class="fas fa-skull fa-lg"></i></a></div>` : 
                            DATA.sliderReminders === '2' ? `<div class="gravedanger" title="Grave Danger Inactive"><a href="https://www.neopets.com/halloween/gravedanger/index.phtml"><i class="fas fa-skull inactive"></i></a></div>` : ''
                        }</div>` : ''}
                    </div>
    ...
    function buildMenus() {
        ...
        $('#toggle_settings_bodies input[type="range"]').each(function () {
            $(this).val(DATA[$(this).attr('name')]);
        });
        $('#sliderReminders').val(DATA.sliderReminders);
    ...
    function settings_HTML() {
        ...
        const html =
            ...
            <div class="section"> <table id="color_settings"> <tr> <td> <div>Color:</div> <input class="picker" id="colorpicker"> <input class="picker_text" id="colorpicker_text"> </td> <td> <div>Accent<br>Color:</div> <input class="picker" id="subcolorpicker"> <input class="picker_text" id="subcolorpicker_text"> <div id="increment"> <i class="fas fa-caret-up"></i> <i class="fas fa-caret-down"></i> <b id="incrementLabel">${DATA.i}</b> </div> </td> <td> <div>Border<br>Color:</div> <input class="picker" id="bdrcolorpicker"> <input class="picker_text" id="bdrcolorpicker_text"> </td> <td> <div>BG<br>Color:</div> <input class="picker" id="bgcolorpicker"> <input class="picker_text" id="bgcolorpicker_text"> </td> </tr> </table> </div>
            <div class="section" id="toggle_settings_section"> <div id="toggle_settings_tabs"> <div name="general" class="tab-active">General</div> <div name="reminders">Reminders</div> <div name="stats">Stats Slider</div> <div name="misc">BETA</div> </div>
            <div id="toggle_settings_bodies">
            <table name="general" class="tab-active"> <tr> <td> <table> <tr> <td> <div>navigation menu</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="showNav" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>pet stats slider</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="showStats" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>keep active pet at top</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="stickyActive" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>display true expression</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="trueExpression" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> <td> <table> <tr> <td> <div>jumbo sidebar</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="jumbo"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>always use beta theme bg</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="betaBG"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>all accounts</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="allAccts" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>debug mode</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="debug"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> </tr> </table>
            <table name="reminders"> <tr> <td> <table> <tr> <td> <div>neolodge reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="neolodge"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>training reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="training"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>grave danger reminder</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="gravedanger"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> <td> <table> <tr> <td> <div>show remaining time in slider</div> </td> <td> <select id="sliderReminders"> <option value="0">No</option> <option value="1">Show Active</option> <option value="2">Show All</option> </select> </td> </tr> </table> </td> </tr> </table>
            ...
            <table name="misc"> <tr> <td> <table> <tr> <td> <div>NP links to inventory</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="npLinkInv" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>secondary link to bank</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="npLinkBank" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>NC links to mall</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="ncLinkMall" /> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> </table> </td> <td> <table> <tr> <td> <div>compact mode</div> </td> <td> <div class="pretty p-switch p-fill"><input type="checkbox" name="compact"> <div class="state p-success"><label> ‏‏‎ </label></div> </div> </td> </tr> <tr> <td> <div>border width</div> </td> <td> <input class="slider" type="range" name="border_width" min="0" max="6"> </td> </tr> 
            <tr> <td> <div>gap width</div> </td> <td> <input class="slider" type="range" name="gap_width" min="0" max="20" step="2"> </td> </tr> </table> </td> </tr> </table>
            </div>
    ...
    function createCSS() {
        ...
        const bdrcolor = getBdrColor();
        const bgcolor = getBgColor();
        const textcolor = getTextColor(bgcolor);
        const headertextcolor = getTextColor(color);
        const bdrtextcolor = getTextColor(bdrcolor);
        const bdrwidth = DATA.border_width;
        const gapwidth = DATA.gap_width;
    ...
    function Coltzan() {
        ...
        if (blurb) {
            ...
            if (match) {
                ...
                const petname = match[1];
                if (petname == "All") {
                    for (let each_petname in PETS)
                        if (PETS[each_petname].owner == USER)
    ...
    function Neolodge() {
        ...
        // cockroach towers, max nights
        $('select[name="hotel_rate"]').val('5');
        $('select[name="nights"] option:last-child').prop('selected', true);

        const petmatch = location.search.match(/pet_name=(\w+)/i);
        if (petmatch?.[1]) {
            $(`select[name="pet_name"] option:contains("${petmatch[1]}")`).prop('selected', true);
        } else {
    ...
    function QuestLog() {
        ...
        waitForElm('.ql-quest-description').then(() => {
    ...
    function getBdrColor(set) {
        if (set) DATA.bdrcolor = set;
        return String(DATA.bdrcolor) || BDR;
    }
    ...
    function changeBdrColor(tinycolor) {
        let color;
        if (tinycolor)
            color = getBdrColor(tinycolor.toRgbString());
        else { // if none selected, return to theme color
            DATA.bdrcolor = '';
            color = getBdrColor();
            $("#bdrcolorpicker").spectrum('set', color); // update the picker too
        }
        $('#bdrcolorpicker_text').val(color);
        $('#container__psm>table#psm').css('border-color', color);
        $('#container__psm>table#psm>tbody>tr').css('border-color', color);
        $('#container__psm>table#psm>tbody>tr#row_petsHeader').css('background-color', color).css('color', getTextColor(color));
        set_items(true, false);
    }
    ...
    function settings_functionality() {
        ...
        $("#bdrcolorpicker").spectrum({
            ...
            showButtons: false,
            allowEmpty: true,
            move: function (tinycolor) { changeBdrColor(tinycolor) }
        });
        ...
        $('#bdrcolorpicker_text').blur(function () {
            const $picker = $('#bdrcolorpicker');
            $picker.spectrum('set', $(this).val());
            changeBdrColor($picker.spectrum('get'));
        });
        ...
        $('#toggle_settings_bodies input[type="range"]').on('input', function () {
        ...
        $('#sliderReminders,#hp_mode,#bd_mode').change(function () {
    ...
    function main_functionality() {
        ...
        const styleScroll = () => { // reposition module based on container size size and scroll position
            ...
            const mHeight = $CONTAINER.height() * (DATA.jumbo ? 1.5 : 1);
        ...
        // LEGACY HANDLING
            ...
            const resizeObserver = new ResizeObserver((entries) => { // jumbo observer
                const isJumbo = $(entries[0].target).hasClass('jumbo');
                const sidebarHeight = isJumbo ? entries[0]?.contentRect?.height *1.5+18 || 'unset' : 'unset';
                $('td.content').height(sidebarHeight);
            });
            if (document.getElementsByClassName('sidebar').length) resizeObserver.observe(document.getElementsByClassName('sidebar')[0]);
        }
