...
(function() {
    ...
    function add_pet(petname) {
        ...
        var neolodge = DATA.neolodge && (new Date).getTime() > PETS[petname].neolodge ? ' style="display: block;"' : '';
