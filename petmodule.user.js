...
(function() {
    ...
    function buildMenus() {
        if (!IS_BETA && DATA.betaBG) $('body').addClass('betaBG');
    ...
    function Knowledge(blurb) {
         ...
         * ?                                                                    Active gains 1 int
         * ?                                                                    Active is healed to full health
         */
    }
